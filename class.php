            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  $sql = "SELECT *,COUNT(classroom) AS Totclass FROM classroom JOIN student on classroom.hno=student.classroom GROUP by student.classroom;";
                  ...
                  if ($result->num_rows > 0) {
                   // output data of each row
                     while($row = $result->fetch_assoc()) {
                        ...
                        echo "<tr><td> " . $row["hno"] . " </td><td> " . $row["title"] . "</td><td>" . $row["location"] . "</td><td>" . $row["capacity"] . "</td><td>" . $row["Totclass"] . "</td></tr>";
                      }   
                                  }
