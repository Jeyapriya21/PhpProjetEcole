 ...
 <?php include_once 'header.php'; ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Ecole</a></li>
 ...
 <div class="row">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red">
            <div class="inner">
              <?php $sql4="SELECT count(*) as a from director"; 
            ...
            <a href="#" class="small-box-footer"><i class="fa fa-id-card" aria-hidden="true"></i></a>
          </div>
        </div>
        <!-- ./col -->
      </div>
