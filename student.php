...
<?php
 ...
 $sid =$fname =$lname = $classroom = $dob = $gender = $address = $teacher=" ";
                  ...
                  if ($result->num_rows > 0) {
                   // output data of each row
                     while($row = $result->fetch_assoc()) {
                      ...
                      echo "<option value='".$row["tid"]."' >".$row["fname"]." ".$row["lname"]." - ID:".$row["tid"]."</option>";
                       }
                                  }
              ...
              if (isset($_POST['submit'])) {
                ...
                $teacher = $_POST['teacher'];}
                  ...
                  try {
                    ...
                    $sql = "INSERT INTO student (sid,fname,lname,bday,address,gender,teacher,classroom,email) VALUES ('".$sid."', '".$fname."', '".$lname."','".$dob."','".$address."','".$gender."','".$teacher."','".$classroom."','".$email."')";
...
<!-- general form elements -->
 ...
 <div class="form-group">
                ...
                <label>teacher</label>
                <select name="teacher" class="form-control select2 select2-hidden-accessible" style="width: 100%;" tabindex="-1" aria-hidden="true" >
                 <option value="0">Select teacher</option>
                  ...
                  if ($result->num_rows > 0) {
                   // output data of each row
                     while($row = $result->fetch_assoc()) {
                      ...
                      echo "<option "; if($teacher==$row["tid"]){echo 'selected="selected"';} echo " value='".$row["tid"]."' >".$row["fname"]." ".$row["lname"]." - ID:".$row["tid"]."</option>";
                       }
                                  }
...
$email = $_POST['email'];
                ...
                $teacher = $_POST['teacher'];
                  ...
                  try {
                    ...
                    $sql = "UPDATE student set fname='".$fname."',lname='".$lname."',bday='".$dob."',address='".$address."',gender='".$gender."',teacher='".$teacher."',classroom='".$classroom."',email='".$email."' where sid='".$sid."'";
                   

                   // $sql = "INSERT INTO student (sid,fname,lname,bday,address,gender,teacher,classroom) VALUES ('".$sid."', '".$fname."', '".$lname."','".$dob."','".$address."','".$gender."','".$teacher."','".$classroom."')";
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  if ($result->num_rows > 0) {
                   // output data of each row
                     while($row = $result->fetch_assoc()) {
                      echo "<tr><td> " . $row["sid"]. " </td><td> " . $row["fname"]." ". $row["lname"]. " </td><td> " . $row["bday"]. "</td><td>" . $row["gender"]. "</td><td>" . $row["address"]. "</td><td>" . $row["classroom"]. "</td><td>" . $row["teacher"]. "</td><td><a href='student.php?update=". $row["sid"]."'><small class='label  bg-orange'>Update</small></a></td></tr>";
                       }
                                  }
