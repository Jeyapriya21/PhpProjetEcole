...
<?php
 ...
 $tid =$fname =$lname = $num = $address = $contact  = $skill =$email=" ";
            ...
            <form role="form" method="POST" >
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input name="num" type="text" class="form-control" id="exampleInputPassword1" placeholder="Enter House Number" required>
...
$email = $_POST['email'];
 $contact = $_POST['contact'];
                  ...
                  try {
                    ...
                    $sql = "INSERT INTO Teacher (tid,fname,lname,num,address,skill,contact,email) VALUES ('".$tid."', '".$fname."', '".$lname."','".$num."','".$address."','".$skill."','".$contact."','".$email."')";
          ...
          <div class="box box-primary">
            ...
            <form role="form" method="POST" >
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="exampleInputPassword1">Number</label>
                  <input name="num" type="text" class="form-control" id="exampleInputPassword1"  required value=<?php echo "'".$num."'"; ?>>
                </div>
              ...
              if (isset($_POST['submit'])) {
                ...
                $contact = $_POST['contact'];
                  ...
                  try {
                   ...
                   $sql = "UPDATE teacher SET fname='".$fname."',lname='".$lname."',num='".$num."',address='".$address."',skill='".$skill."',contact='".$contact."',email='".$email."' WHERE tid = '".$tid."'";
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  if ($result->num_rows > 0) {
                   // output data of each row
                     while($row = $result->fetch_assoc()) {
                      echo "<tr><td> " . $row["tid"]. " </td><td> " . $row["fname"]." ". $row["lname"]. " </td><td>". $row["num"]. " " . $row["address"]. "</td><td>" . $row["contact"]. "</td><td>" . $row["skill"]. "</td><td><a href='teacher.php?update=". $row["tid"]."'><small class='label  bg-orange'>Update</small></a></td></tr>";
                       }
                                  }
